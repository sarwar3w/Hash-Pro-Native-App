...
import DepositWithdraw from '../Common/DepositWithdraw/DepositWithdraw';
            ...
            {footerOn && (
              <View>
                <View style={styles.upperFooter}>
                  ...
                  <View style={styles.waletValue}>
                    <View>
                      <View
                        style={[styles.innerCol, {alignItems: 'flex-start'}]}>
                        <Text style={styles.valueText}>15640033</Text>
                        <Text style={styles.textStyle}>Total Participants</Text>
                      </View>
                    </View>
                    <View>
                      <View style={[styles.innerCol, {alignItems: 'flex-end'}]}>
